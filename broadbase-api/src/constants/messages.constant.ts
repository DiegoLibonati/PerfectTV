...
export const MESSAGES_SUCCESS: MessagesSuccess = {
  ...
  deleteChannel: "[Api] Channel deleted.",
...
export const MESSAGES_NOT: MessagesNot = {
  foundResource: "[Api] Resource not found.",
  ...
  validFields: "[Api] Invalid fields.",
  validParams: "[Api] Invalid params.",
  validQueries: "[Api] Invalid queries.",
};

export const MESSAGES_ERROR: MessagesError = {
  generic: "[Api] Something went wrong!",
  itemAlreadyExistsInDatabase: "[Api] An item already exists in the database!",
